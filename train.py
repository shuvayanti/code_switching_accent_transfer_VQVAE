...
import sys5_lang as sys5_model_lang
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if model_type == 'sys5':
        ...
        model_fn = sys5_model_lang.Model(lang_dims, nspeakers=nspeakers,rnn_dims=config.rnn_dims, fc_dims=config.fc_dims, global_decoder_cond_dims=nspeakers,upsample_factors=config.upsample_factors, normalize_vq=True, noise_x=True, noise_y=True)
        #model_fn = env.restore_warmup(warm, config.warmup_model)
