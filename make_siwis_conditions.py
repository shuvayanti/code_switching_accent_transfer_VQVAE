...
infile = "/home/s1995633/s1995633/dissertation/siwis_database/speaker_index_updated/index.pkl"
...
os.makedirs("/home/s1995633/s1995633/dissertation/siwis_database/siwis_conditions",exist_ok=True)

outfile = "/home/s1995633/s1995633/dissertation/siwis_database/siwis_conditions/siwis_condition1_updated.txt"
output = open(outfile, "w")
[output.write("\n".join(v)+"\n") for k,v in c1.items()]
output.close()
outfile = "/home/s1995633/s1995633/dissertation/siwis_database/siwis_conditions/siwis_condition2_updated.txt"
output = open(outfile, "w")
[output.write("\n".join(v)+"\n") for k,v in c2.items()]
output.close()
outfile = "/home/s1995633/s1995633/dissertation/siwis_database/siwis_conditions/siwis_condition3_updated.txt"
output = open(outfile, "w")
[output.write("\n".join(v)+"\n") for k,v in c3.items()]
output.close()
outfile = "/home/s1995633/s1995633/dissertation/siwis_database/siwis_conditions/siwis_condition4_updated.txt"
output = open(outfile, "w")
[output.write("\n".join(v)+"\n") for k,v in c4.items()]
output.close()
...
newpickle = "/home/s1995633/s1995633/dissertation/siwis_database/speaker_index_updated/index2.pkl"
...
with open('/home/s1995633/s1995633/dissertation/siwis_database/speaker_index_updated/index2.pkl', 'rb') as f:
    index = pickle.load(f)
train_set = index[:]
